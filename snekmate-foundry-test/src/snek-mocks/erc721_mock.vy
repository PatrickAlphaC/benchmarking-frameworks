...
# syntax.
from snekmate.src.snekmate.tokens.interfaces import IERC721Metadata
...
# interface, which is written using standard Vyper
# syntax.
from snekmate.src.snekmate.tokens.interfaces import IERC721Enumerable
...
# interface, which is written using standard Vyper
# syntax.
from snekmate.src.snekmate.tokens.interfaces import IERC721Permit
implements: IERC721Permit


# @dev We import and implement the `IERC4906` interface,
# which is written using standard Vyper syntax.
from snekmate.src.snekmate.tokens.interfaces import IERC4906
implements: IERC4906


# @dev We import and implement the `IERC5267` interface,
# which is written using standard Vyper syntax.
from snekmate.src.snekmate.utils.interfaces import IERC5267
implements: IERC5267


# @dev We import and initialise the `ownable` module.
from snekmate.src.snekmate.auth import ownable as ow
initializes: ow


# @dev We import and initialise the `erc721` module.
from snekmate.src.snekmate.tokens import erc721
