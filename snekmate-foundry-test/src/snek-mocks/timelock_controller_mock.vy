...
# syntax.
from snekmate.src.snekmate.auth.interfaces import IAccessControl
...
# interface, which is written using standard Vyper
# syntax.
from snekmate.src.snekmate.tokens.interfaces import IERC721Receiver
...
# interface, which is written using standard Vyper
# syntax.
from snekmate.src.snekmate.tokens.interfaces import IERC1155Receiver
implements: IERC1155Receiver


# @dev We import and initialise the `access_control` module.
from snekmate.src.snekmate.auth import access_control as ac
initializes: ac


# @dev We import and initialise the `timelock_controller` module.
from snekmate.src.snekmate.governance import timelock_controller as tc
